  ...
  render () {
    return (
      <form className={style.contactForm} onSubmit={this.handleSubmit}>
        ...
        <h4>
          <img src={require('../img/headoffice_green.svg')} className={style.icon} />
        Head Office
        </h4>
        ...
        <h4>
          <img src={require('../img/contact_green.svg')} className={style.icon}/>
        Contact
        </h4>
        <p className={style.description}>0414 236 724 / 342 726</p>
        <h4>
          <img src={require('../img/email_green.svg')} className={style.icon}/>
        Email
        </h4>
        ...
        <div className={style.placeholders}>
          ...
          <p>
            <input type="text" name="Your Query" placeholder="Your Query" className={style.inputBoxQuery} onChange={this.handleChange.bind(this)}/>
          </p>
